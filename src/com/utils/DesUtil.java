...
/*
访问限制报错. Access restriction: The type Resource is not accessible due to restriction on required library
方法一:
...
方法二(终极方法:)
 项目属性preferences>java build path>把右侧libraries 中的JRE System Library 删除重新导入.
*/
